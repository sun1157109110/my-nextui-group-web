...
const siteConfig = {
  ...
  researchList: [
    ...
    {
      label:
        "研究方向三：有机、高分子室温磷光(磷光信号对分子聚集态精细变化的灵敏响应)",
  ...
  news: [
    ...
    {
      label:
        "热烈祝贺XXX的文章“Hole-transporting Materials with Rational Combination of Pyridine and Dibenzo[a,c]phenazine as Electron Acceptor for Dopant-free Perovskite Solar Cells”被Chinese Journal of Chemistry接收！",
      href: "",
      time: "2024-03-27",
      icon: "paper",
    },
    ...
    {
      label:
        "热烈祝贺XXX文章“Organic Persistent RTP Crystals: From Brittle to Flexible by Tunable Self-Partitioned Molecular Packing”被期刊Advanced Materials接收",
      href: "",
      time: "2024-2-11",
      icon: "paper",
    },
  ...
  publish: [
    {
      ...
      title:
        'Xingjie Luo,+ Zhiyu Jiang,+ Siqun Yang, Xiaoyu Ren, Tianli Wang* "Organocatalyzed Asymmetric Conjugate Addition of Alcohols to β-Fluoroalkyl Vinylsulfones by Bifunctional Phosphonium Salt Catalyst" Chem. Eur. J. 2024, e202401325.',
      date: "2024-2-15",
    },
    {
      img: faker.image.urlLoremFlickr({
    ...
    },
    {
      ...
      title:
        "Organocatalytic Dynamic Kinetic ResolutionEnabled Asymmetric Synthesis of Phosphorus-Containing Chiral Helicenes",
      date: "2023-12-15",
    },
    {
      img: faker.image.urlLoremFlickr({
...
siteConfig.members.push(
  ...fakerMembers(Role.PHD, 2),
  ...fakerMembers(Role.MASTER, 6),
);
export { siteConfig };
